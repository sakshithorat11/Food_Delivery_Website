...
if (data.length === 0) {
    return (
      <div>
        <div className=' text-success m-5 w-100 text-center fs-3'>The Cart is Empty!</div>
      </div>
    )
  }
  ...
  //  console.log(data,localStorage.getItem("userEmail"),new Date())
    let response = await fetch("http://localhost:5004/api/orderData", {
      // credentials: 'include',
  ...
  return (
    <div>
      ...
      <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' >
        ...
        <div><h1 className='text-white mt-5 fs-2'>Total Price: {totalPrice}/-</h1></div>
        <div>
